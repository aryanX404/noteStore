...
function loadContributerSteps(){
    ...
    <div class="step-card">
        ...
        <div class="step-data ">Share your well-organized notes in PDF format with basic details like subject and semester.</div>
        <div class="step-title">Upload Notes</div>
    </div>
    
    <div class="step-card">
        <div class="step-logo"><i class="fa-solid fa-tag"></i></div>
        <div class="step-data">Decide a fair price for your notes. You stay in control of what you earn.</div>
        <div class="step-title">Set Your Price</div>
    </div>
    
    <div class="step-card">
        <div class="step-logo"><i class="fa-solid fa-download"></i></div>
        <div class="step-data">Students discover your notes and purchase them with a one-time payment.</div>
        <div class="step-title">Get Downloads</div>
    </div>
    
    <div class="step-card">
        <div class="step-logo passive-logo"><i class="fa-solid fa-indian-rupee-sign"></i></div>
        <div class="step-data">You earn money every time your notes are downloaded.</div>
...
function loadLearnerSteps(){
    ...
    <div class="step-card">
        ...
        <div class="step-data ">Find notes by subject, semester, or college in a few clicks.</div>
        <div class="step-title">Browse Notes</div>
    </div>
   
    <div class="step-card">
        <div class="step-logo"><i class="fa-solid fa-book-open"></i></div>
        <div class="step-data">Preview details and select the notes that match your needs.</div>
        <div class="step-title">Choose a Note</div>
    </div>
    
    <div class="step-card">
        <div class="step-logo"><i class="fa-solid fa-credit-card"></i></div>
        <div class="step-data">Make a one-time payment. No subscriptions or hidden charges.</div>
        <div class="step-title">Pay Once</div>
    </div>
   
    <div class="step-card">
        <div class="step-logo"><i class="fa-solid fa-cloud-arrow-down"></i></div>
        <div class="step-data">Access your notes instantly and study at your own pace.</div>
...
function loadResultBox(){
    if (learnerButton.classList.contains('active')){
        resultBox.innerHTML = `
        <div class="result">
            <p class="outcome">Instant access • One-time payment • No subscriptions <span></p>
